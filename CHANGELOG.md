...
* Document getObjectType and isPromise utilities ([3357b0a](https://github.com/the-spyke/undercut/commit/3357b0a9379c9d28dddd7ef2ce004c2ed5f5cf2f))
* Improve docs for createIterable and getIterator utilities ([5c03584](https://github.com/the-spyke/undercut/commit/5c0358402fd175fc6352edaa7de5df6c8c7c8c10))
* Improve language utilities page layout ([e17d311](https://github.com/the-spyke/undercut/commit/e17d311a314d1a2da238336bfd16a9b217c8e94a))
* add faq page ([54b7528](https://github.com/the-spyke/undercut/commit/54b7528756ab905e5209a453e8196608e0e1ab8c))
* add object utilities docs ([460704c](https://github.com/the-spyke/undercut/commit/460704c8d3a9c3ef23480ff31e79b48c88fe756d))
* improve commit type docs ([48c28f8](https://github.com/the-spyke/undercut/commit/48c28f8fb9e66c2f874f1ceb5f34a8c668dad08c))
* sort commit types, add release to types ([2f9fd82](https://github.com/the-spyke/undercut/commit/2f9fd8297b7754cb871deac5953b547da862b6c0))

### :house: Internal

* **ci:** Allow overriding script name for tests on CircleCI ([dbe55dc](https://github.com/the-spyke/undercut/commit/dbe55dcd01973a689cf73cba25f4fca95b68622b))
...
* **deps:** Update @spyke/eslint-config to 1.1.0 ([535b569](https://github.com/the-spyke/undercut/commit/535b569bc6017c66788cc59703bed0885ade7e17))
...
* **utils:** Use real temp folder for Git tests ([98ed164](https://github.com/the-spyke/undercut/commit/98ed164f6815dbc0205e541edbf4f5eb79d13b39))
...
* **website:** Remove excess Docusaurus settings for Netlify deployment ([c05829b](https://github.com/the-spyke/undercut/commit/c05829b3567f354fd2543eb8b78ccefffc7e83a0))
* **website:** Replace references to GitHub Pages with Netlify ([d7853df](https://github.com/the-spyke/undercut/commit/d7853dfaba1f355e995e8595113a0db940985003))
* **website:** add a link for object utils ([b54dc6e](https://github.com/the-spyke/undercut/commit/b54dc6e2b4903b77586443f913a1746c2cdc5b3c))
* **website:** add netify bage ([df066b0](https://github.com/the-spyke/undercut/commit/df066b0186a91749c10804d2e53b71fc55d23e2b))
* **website:** fix target blank links ([22b0a56](https://github.com/the-spyke/undercut/commit/22b0a56efbbf876b4559c20c237470a4563fbc21))
* **website:** improve support page links ([bc54245](https://github.com/the-spyke/undercut/commit/bc542459bb73fd5c51429ced5e1a7a406e1184d0))
* **website:** update docusaurus ([d81cc9c](https://github.com/the-spyke/undercut/commit/d81cc9c7669354e77071ac35383d4c610e717058))
* **website:** use latest for the link to dev.to ([901f868](https://github.com/the-spyke/undercut/commit/901f8683b623dae490a2dd61d36357332644d3f4))
* Add code of conduct document ([974b993](https://github.com/the-spyke/undercut/commit/974b9937106541c2cac8cc48cd243fdf6d8569f8))
* Add junit.xml to gitignore ([d94c862](https://github.com/the-spyke/undercut/commit/d94c862b141b63ba402dc8a93f0df0e25046ff83))
* Allow to run integration tests independently ([8cbc74c](https://github.com/the-spyke/undercut/commit/8cbc74c997d4721fb80fe867badafe0ae62a18ab))
* Fix JUnit crash by restoring correct CWD after tests ([70e607c](https://github.com/the-spyke/undercut/commit/70e607c63d4de7dd53560463d3f3c2e7efcdc7ee))
* Replace warning sign in changelog template ([b08804c](https://github.com/the-spyke/undercut/commit/b08804cc6d6ebebf943449c51a1264019167fa17))
* Set YAML indentation to 2 spaces ([9ad833d](https://github.com/the-spyke/undercut/commit/9ad833d26eca0b5dd772346eb1c8619c1eb0e554))
* add conventional commits flag to the release script ([961160f](https://github.com/the-spyke/undercut/commit/961160f523f6a2efd4c113994b78a3bfcd2ede59))
* add custom changelog preset ([1d4d9ae](https://github.com/the-spyke/undercut/commit/1d4d9aea3a7af995b7d5dd4acfd4611e514d549a))
* remove first release link ([9e7a936](https://github.com/the-spyke/undercut/commit/9e7a936210ec48e829dd8761157c0b887f8ee2ca))
